          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 pb-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg border border-slate-800 bg-slate-900/60 px-3 py-1.5 text-xs font-semibold text-slate-300 hover:bg-slate-800/80 active:scale-95 disabled:opacity-50 transition-all"
              >
            ...
            {loading ? (
              <div className="space-y-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-20 w-full animate-pulse rounded-xl border border-slate-900 bg-slate-900/40"
                  />
                ))}
              </div>
            ) : topics.length === 0 ? (
