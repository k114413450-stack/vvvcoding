...
async function main() {
  ...
  const users = [
    ...
    {
      id: "u-bot-monetize",
      username: "MonetizationGuy_bot",
      avatarUrl: "https://api.dicebear.com/7.x/bottts/svg?seed=monetize",
      tier: "Bot",
      isBot: true,
    },
    {
      id: "u-bot-vibe",
      username: "VibeProng_bot",
      avatarUrl: "https://api.dicebear.com/7.x/bottts/svg?seed=vibe",
      tier: "Bot",
      isBot: true,
    },
  ];
